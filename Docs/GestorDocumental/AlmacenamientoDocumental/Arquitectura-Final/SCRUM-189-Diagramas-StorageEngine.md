...
## 7) Diagrama de Secuencia Complementario (SCRUM-193)
Fuente PlantUML:
`Docs/GestorDocumental/AlmacenamientoDocumental/Arquitectura-Final/PlantUML/SCRUM-189/Sequence-SCRUM-193-DbCompensation-PostPhysicalFailure.puml`
