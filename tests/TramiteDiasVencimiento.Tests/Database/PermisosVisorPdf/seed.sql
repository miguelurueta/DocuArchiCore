INSERT INTO `remit_dest_interno` (`id_Remit_Dest_Int`, `Login_Usuario`)
VALUES
(141, 'usuario.141'),
(142, 'usuario.142')
...
VALUES
('workflow', 'Workflow', 'Visor PDF en workflow', 1, 0)
ON DUPLICATE KEY UPDATE
...
('pdf.annotate.open_signature_modal', 'pdf', 'annotate_open_signature_modal', 'Abrir modal firma', 1),
('pdf.annotate.signature.draw', 'pdf', 'annotate_signature_draw', 'Dibujar firma', 1),
('pdf.annotate.signature.upload', 'pdf', 'annotate_signature_upload', 'Subir firma', 1),
('pdf.annotate.signature.personal', 'pdf', 'annotate_signature_personal', 'Firma personal', 1),
('pdf.annotate.signature.place', 'pdf', 'annotate_signature_place', 'Ubicar firma', 1),
