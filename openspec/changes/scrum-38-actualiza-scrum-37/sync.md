...
Use this template at the start of each Jira ticket (`SCRUM-38`) to decide exactly where to run `opsxj:new` and `opsxj:archive`.

## Ticket

- Jira key: `SCRUM-38`
- Summary: `ACTUALIZA-SCRUM-37`
- Coordinator change: `openspec/changes/scrum-38-actualiza-scrum-37/`
...
Run `opsxj:new SCRUM-38` only in rows with `Impacta? = yes`.
Run `opsxj:archive SCRUM-38` only after the repo PR is merged.
