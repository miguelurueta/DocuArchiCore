...
- [x] 1.1 Revisar el issue Jira SCRUM-61 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-61/spec.md con requisitos finales.
...
- `dotnet build DocuArchiCore.sln`: ejecutado OK, 0 errores (warnings existentes).
- `dotnet test tests/TramiteDiasVencimiento.Tests --filter FullyQualifiedName~RelacionCamposRutaWorklflow`: ejecucion intentada; bloqueada por errores de compilacion preexistentes en `ConfiguracionPlantilla*Tests` no relacionados con SCRUM-61.
