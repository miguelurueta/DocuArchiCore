...
|---|---|---|---|---|---|---|---|
| DocuArchi.Api | yes | implementation_required | registro DI de fase física FileSystem/XML/compensación | done | n/a | pending | tracked |
...
| MiApp.Services | yes | implementation_required | implementación de path resolver, file/xml writer, compensation manager y ejecutor físico | done | n/a | pending | tracked |
| MiApp.Repository | no | no_code_change | esta fase no accede a DB ni agrega repositories de datos | n/a | n/a | n/a | n_a |
| MiApp.Models | yes | implementation_required | ajuste de contrato `StoragePhysicalStatusModel` (`NombreArchivoFinal`) | done | n/a | pending | tracked |
