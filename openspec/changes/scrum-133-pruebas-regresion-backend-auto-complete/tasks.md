...
- [x] 1.1 Revisar el issue Jira SCRUM-133 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-133/spec.md con requisitos finales.
...
- [x] 4.3 Validar con OpenSpec; archivar despues del merge.
