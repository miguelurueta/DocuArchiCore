...
- Crear artefactos base del cambio a partir del issue SCRUM-59.
...
### New Capabilities
- jira-scrum-59: Inicio de cambio OpenSpec originado en Jira issue SCRUM-59.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-59
- OpenSpec change path: openspec/changes/scrum-59-implementacion-solicita-configuracion-pl/
