...
- Crear artefactos base del cambio a partir del issue SCRUM-91.
...
### New Capabilities
- jira-scrum-91: Inicio de cambio OpenSpec originado en Jira issue SCRUM-91.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-91
- OpenSpec change path: openspec/changes/scrum-91-actualizacion-validarusuarioworkflowinte/
