...
|---|---|---|---|---|---|---|---|
| DocuArchi.Api | yes | implementation_required | registrar `IWorkflowInboxQueryBuilder` en DI para que el componente quede disponible en runtime | done | n/a | pending | in_progress |
...
| MiApp.DTOs | yes | implementation_required | crear contrato `WorkflowInboxDynamicTableRequestDto` faltante para el querybuilder | done | n/a | pending | in_progress |
...
| MiApp.Repository | yes | implementation_required | implementar `IWorkflowInboxQueryBuilder`, `WorkflowInboxQueryBuilder` y policy en `Workflow/BandejaCorrespondencia` | done | n/a | pending | in_progress |
