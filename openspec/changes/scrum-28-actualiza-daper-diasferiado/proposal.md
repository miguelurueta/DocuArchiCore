...
- Crear artefactos base del cambio a partir del issue SCRUM-28.
...
### New Capabilities
- jira-scrum-28: Inicio de cambio OpenSpec originado en Jira issue SCRUM-28.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-28
- OpenSpec change path: openspec/changes/scrum-28-actualiza-daper-diasferiado/
