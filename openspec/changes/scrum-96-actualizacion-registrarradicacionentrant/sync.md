...
| DocuArchiCore | yes | implementation_required | actualiza pruebas, spec, tasks y evidencia tecnica | done | https://github.com/miguelurueta/DocuArchiCore/pull/110 | pending | in_review |
