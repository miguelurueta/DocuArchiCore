...
- Crear artefactos base del cambio a partir del issue SCRUM-54.
...
### New Capabilities
- jira-scrum-54: Inicio de cambio OpenSpec originado en Jira issue SCRUM-54.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-54
- OpenSpec change path: openspec/changes/scrum-54-actualizacion-mensaje-maxleng-validacion/
