...
Use this template at the start of each Jira ticket (`SCRUM-54`) to decide exactly where to run `opsxj:new` and `opsxj:archive`.

## Ticket

- Jira key: `SCRUM-54`
- Summary: `ACTUALIZACION-MENSAJE_MAXLENG-VALIDACION-CAMPOS-RADICACION`
- Coordinator change: `openspec/changes/scrum-54-actualizacion-mensaje-maxleng-validacion/`
...
| $(DocuArchiCore.Web) | $(no) | $(fuera de alcance) | $(n/a) | $(n/a) | $(n/a) | $(n_a) |
...
Run `opsxj:new SCRUM-54` only in rows with `Impacta? = yes`.
Run `opsxj:archive SCRUM-54` only after the repo PR is merged.
