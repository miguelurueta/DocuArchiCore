...
- [x] 1.1 Revisar el issue Jira SCRUM-176 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-176/spec.md con requisitos finales.
...
- Implementacion real aplicada en `DocuArchi.Api` y `MiApp.Services`.
- `MiApp.Repository` y `MiApp.DTOs` se mantienen sin diff por reutilizacion de componentes existentes.
- Se agrega prueba unitaria focal y documentacion tecnica en `DocuArchiCore`.
