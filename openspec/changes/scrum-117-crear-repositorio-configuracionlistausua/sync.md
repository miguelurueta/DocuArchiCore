...
|---|---|---|---|---|---|---|---|
| DocuArchi.Api | yes | implementation_required | registro DI del nuevo repository workflow | done | https://github.com/miguelurueta/DocuArchi.Api/pull/42 | pending | in_review |
| DocuArchiCore | yes | implementation_required | orquestador openspec central | done | https://github.com/miguelurueta/DocuArchiCore/pull/147 | pending | in_review |
...
| MiApp.Repository | yes | implementation_required | nuevo repository workflow para consultar `configuracion_usuario` | done | https://github.com/miguelurueta/MiApp.Repository/pull/32 | pending | in_review |
| MiApp.Models | yes | implementation_required | nuevo modelo tipado para `configuracion_usuario` | done | https://github.com/miguelurueta/MiApp.Models/pull/11 | pending | in_review |
