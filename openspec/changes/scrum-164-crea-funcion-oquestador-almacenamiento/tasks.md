...
- [x] 1.1 Revisar el issue Jira SCRUM-164 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-164/spec.md con requisitos finales.
...
Nota 3.x: En SCRUM-164 se implemento la capa UseCase + Orchestrator base sin acceso DB/FS/XML, preparada para pipeline posterior.
...
Nota 4.2: Prueba focal bloqueada por error preexistente de compilacion en tests no relacionados (`SolicitaListaTiposRespuestaControllerTests`).
