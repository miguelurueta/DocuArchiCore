...
- [x] 1.1 Revisar el issue Jira SCRUM-106 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-106/spec.md con requisitos finales.
...
- [x] 3.1 Ajustar DynamicUiTableBuilder y DTOs para exponer aliases compatibles con AG Grid sin romper MUI.
- [x] 3.2 Confirmar que no se requieren cambios de DI ni nuevas interfaces para el ajuste de contrato.
