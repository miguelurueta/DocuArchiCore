...
- [x] 1.1 Revisar el issue Jira SCRUM-140 y confirmar alcance.
- [x] 1.2 Confirmar repos impactados y rutas destino antes de crear Controllers/DTOs/Models/funciones.
- [x] 1.3 Confirmar estructura/campos requeridos (modelo/DTO nuevos).

## 2. Specs

- [x] 2.1 Completar specs/jira-scrum-140/spec.md con requisitos finales.
...
- [x] 3.1 Implementar API + Service + Repository + Model + DTO con AppResponses y try/catch.
...
- [x] 4.1 Implementar Unit tests (controller/service/repository) y documentar evidencia.
