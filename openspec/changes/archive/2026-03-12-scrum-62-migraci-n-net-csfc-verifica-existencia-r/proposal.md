...
- Crear artefactos base del cambio a partir del issue SCRUM-62.
...
### New Capabilities
- jira-scrum-62: Inicio de cambio OpenSpec originado en Jira issue SCRUM-62.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-62
- OpenSpec change path: openspec/changes/scrum-62-migraci-n-net-csfc-verifica-existencia-r/
