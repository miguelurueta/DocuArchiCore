...
- Crear artefactos base del cambio a partir del issue SCRUM-81.
...
### New Capabilities
- jira-scrum-81: Inicio de cambio OpenSpec originado en Jira issue SCRUM-81.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-81
- OpenSpec change path: openspec/changes/scrum-81-actualiza-dynamic-ui-table-design/
