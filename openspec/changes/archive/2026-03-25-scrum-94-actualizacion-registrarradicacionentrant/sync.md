...
Use this template at the start of each Jira ticket (`SCRUM-94`) to decide exactly where to run `opsxj:new` and `opsxj:archive`.

## Ticket

- Jira key: `SCRUM-94`
- Summary: `ACTUALIZACION-RegistrarRadicacionEntranteAsync`
- Coordinator change: `openspec/changes/scrum-94-actualizacion-registrarradicacionentrant/`
...
| DocuArchiCore | yes | implementation_required | orquestador openspec central | done | https://github.com/miguelurueta/DocuArchiCore/pull/104 | done | archived |
...
| MiApp.Services | yes | implementation_required | implementacion publicada desde diff real | done | https://github.com/miguelurueta/MiApp.Services/pull/47 | done | archived |
...
Run `opsxj:new SCRUM-94` only in rows with `Impacta? = yes`.
