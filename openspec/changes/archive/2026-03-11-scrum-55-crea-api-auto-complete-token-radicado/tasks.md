...
- [x] 1.1 Revisar el issue Jira SCRUM-55 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-55/spec.md con requisitos finales.
...
- [x] 4.2 Ejecutar dotnet test (bloqueado por errores preexistentes de compilacion en tests no relacionados a SCRUM-55).
