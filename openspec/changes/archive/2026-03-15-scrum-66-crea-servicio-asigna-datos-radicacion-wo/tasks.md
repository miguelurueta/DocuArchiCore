...
- [x] 1.1 Revisar el issue Jira SCRUM-66 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-66/spec.md con requisitos finales.
...
- [x] 3.1 Implementar servicio interno de asignacion en memoria con AppResponses y try/catch sin crear controller ni repository.
