...
- Crear artefactos base del cambio a partir del issue SCRUM-78.
...
### New Capabilities
- jira-scrum-78: Inicio de cambio OpenSpec originado en Jira issue SCRUM-78.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-78
- OpenSpec change path: openspec/changes/scrum-78-opsxdeploy-automatizar-preparaci-n-y-val/
