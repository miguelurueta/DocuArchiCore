...
Use this template at the start of each Jira ticket (`SCRUM-49`) to decide exactly where to run `opsxj:new` and `opsxj:archive`.

## Ticket

- Jira key: `SCRUM-49`
- Summary: `CORRECION-VALIDACION-RADICACION-CAMPO-Descripcion_Documento`
- Coordinator change: `openspec/changes/scrum-49-correcion-validacion-radicacion-campo-de/`
...
Run `opsxj:new SCRUM-49` only in rows with `Impacta? = yes`.
Run `opsxj:archive SCRUM-49` only after the repo PR is merged.
