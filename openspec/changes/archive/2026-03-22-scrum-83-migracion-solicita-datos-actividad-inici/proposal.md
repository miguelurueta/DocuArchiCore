...
- Crear artefactos base del cambio a partir del issue SCRUM-83.
...
### New Capabilities
- jira-scrum-83: Inicio de cambio OpenSpec originado en Jira issue SCRUM-83.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-83
- OpenSpec change path: openspec/changes/scrum-83-migracion-solicita-datos-actividad-inici/
