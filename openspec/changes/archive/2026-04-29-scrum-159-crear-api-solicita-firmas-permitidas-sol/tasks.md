...
- [x] 1.1 Revisar el issue Jira SCRUM-159 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-159/spec.md con requisitos finales.
...
- [x] 5.1 Crear `Docs/GestionCorrespondencia/FirmasPermitidas/SCRUM-159-Arquitectura.md`.
- [x] 5.2 Crear `Docs/GestionCorrespondencia/FirmasPermitidas/SCRUM-159-Implementacion-Detallada.md`.
- [x] 5.3 Crear `Docs/GestionCorrespondencia/FirmasPermitidas/SCRUM-159-Integracion-Frontend.md`.
- [x] 5.4 Crear `Docs/GestionCorrespondencia/FirmasPermitidas/SCRUM-159-Pruebas.md`.
- [x] 5.5 Crear `Docs/GestionCorrespondencia/FirmasPermitidas/SCRUM-159-Observabilidad.md`.
