...
- Crear artefactos base del cambio a partir del issue SCRUM-72.
...
### New Capabilities
- jira-scrum-72: Inicio de cambio OpenSpec originado en Jira issue SCRUM-72.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-72
- OpenSpec change path: openspec/changes/scrum-72-crea-repository-solicita-estructura-conf/
