...
Use this template at the start of each Jira ticket (`SCRUM-58`) to decide exactly where to run `opsxj:new` and `opsxj:archive`.

## Ticket

- Jira key: `SCRUM-58`
- Summary: `CORRECION-CONSULTA-CONFIGURACION-PLANTILLA-SCRUM-57`
- Coordinator change: `openspec/changes/scrum-58-correcion-consulta-configuracion-plantil/`
...
Run `opsxj:new SCRUM-58` only in rows with `Impacta? = yes`.
Run `opsxj:archive SCRUM-58` only after the repo PR is merged.
