...
- [x] 1.1 Revisar el issue Jira SCRUM-74 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-74/spec.md con requisitos finales.
...
- [x] 3.1 Implementar repository-only con AppResponses, try/catch y consulta parametrizada por `idPlantilla`.
- [x] 3.2 Registrar interfaces en Program.cs (Repositories R).
