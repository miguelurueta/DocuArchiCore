...
- Crear artefactos base del cambio a partir del issue SCRUM-89.
...
### New Capabilities
- jira-scrum-89: Inicio de cambio OpenSpec originado en Jira issue SCRUM-89.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-89
- OpenSpec change path: openspec/changes/scrum-89-implementacio-solicitaestructuraidusuari/
