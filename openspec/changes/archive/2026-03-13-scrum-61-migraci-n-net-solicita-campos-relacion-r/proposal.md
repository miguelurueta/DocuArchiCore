...
- Crear artefactos base del cambio a partir del issue SCRUM-61.
...
### New Capabilities
- jira-scrum-61: Inicio de cambio OpenSpec originado en Jira issue SCRUM-61.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-61
- OpenSpec change path: openspec/changes/scrum-61-migraci-n-net-solicita-campos-relacion-r/
