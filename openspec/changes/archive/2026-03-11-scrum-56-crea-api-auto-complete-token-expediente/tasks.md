...
- [x] 1.1 Revisar el issue Jira SCRUM-56 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-56/spec.md con requisitos finales.
...
- [x] 4.2 Ejecutar dotnet test (bloqueado por errores preexistentes de compilacion en tests no relacionados a SCRUM-56).
- [x] 4.3 Validar y archivar con OpenSpec.
  - Archivado ejecutado al cierre de SCRUM-56; la ejecucion local de `dotnet restore/test` sigue bloqueada por configuracion del SDK/entorno.
