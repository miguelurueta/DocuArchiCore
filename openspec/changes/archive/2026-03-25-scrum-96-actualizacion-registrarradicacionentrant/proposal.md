...
- Crear artefactos base del cambio a partir del issue SCRUM-96.
...
### New Capabilities
- jira-scrum-96: Inicio de cambio OpenSpec originado en Jira issue SCRUM-96.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-96
- OpenSpec change path: openspec/changes/scrum-96-actualizacion-registrarradicacionentrant/
