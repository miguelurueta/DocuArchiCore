...
- Crear artefactos base del cambio a partir del issue SCRUM-80.
...
### New Capabilities
- jira-scrum-80: Inicio de cambio OpenSpec originado en Jira issue SCRUM-80.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-80
- OpenSpec change path: openspec/changes/scrum-80-opsxdeploy-generar-o-asegurar-estructura/
