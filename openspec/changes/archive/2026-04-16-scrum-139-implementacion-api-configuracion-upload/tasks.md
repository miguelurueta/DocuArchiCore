...
- [x] 1.1 Revisar el issue Jira SCRUM-139 y confirmar alcance.
- [x] 1.2 Confirmar repos impactados y rutas destino antes de crear Controllers/DTOs/Models/funciones.
- [x] 1.3 Confirmar estructura/campos requeridos (sin nuevo modelo adicional).

## 2. Specs

- [x] 2.1 Completar specs/jira-scrum-139/spec.md con requisitos finales.
...
- [x] 3.1 Implementar Controller + Service usando repository existente (SCRUM-138) con AppResponses y try/catch.
