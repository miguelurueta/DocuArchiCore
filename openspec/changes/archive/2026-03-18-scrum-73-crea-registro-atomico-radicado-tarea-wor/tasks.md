...
- [x] 1.1 Revisar el issue Jira SCRUM-73 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-73/spec.md con requisitos finales.
...
- [x] 3.1 Implementar repository atomico con DTO/modelos, Dapper, AppResponses, try/catch y rollback.
- [x] 3.2 Registrar interfaces en Program.cs (Repositories R solamente).
- [x] 3.3 Integrar cambios de aplicacion y verificar compilacion local.

## 4. Test

- [x] 4.1 Implementar Unit/Integration tests y documentar evidencia.
