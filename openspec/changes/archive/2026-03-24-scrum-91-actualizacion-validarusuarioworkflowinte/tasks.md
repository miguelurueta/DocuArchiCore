...
- [x] 1.1 Revisar el issue Jira SCRUM-91 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-91/spec.md con requisitos finales.
...
- `dotnet test tests\\TramiteDiasVencimiento.Tests\\TramiteDiasVencimiento.Tests.csproj --filter RegistrarRadicacionEntranteServiceTests -m:1` -> PASS (`7/7`)
- `openspec.cmd validate scrum-91-actualizacion-validarusuarioworkflowinte` -> valid
