...
| DocuArchiCore | yes | implementation_required | orquestador openspec central | done | https://github.com/miguelurueta/DocuArchiCore/pull/99 | done | archived |
| DocuArchiCore.Abstractions | no | no_code_change | solo consulta (sin cambios) | n/a | n/a | n/a | n_a |
| DocuArchiCore.Web | no | no_code_change | solo consulta (sin cambios) | n/a | n/a | n/a | n_a |
| MiApp.DTOs | yes | implementation_required | contrato ValidaPreRegistroWorkflowResultDto ahora incluye RutaWorkflow | done | https://github.com/miguelurueta/MiApp.DTOs/pull/21 | done | archived |
| MiApp.Services | yes | implementation_required | preregistro workflow y validacion de registro consumen RutaWorkflow y bloquean el flujo si falta | done | https://github.com/miguelurueta/MiApp.Services/pull/45 | done | archived |
