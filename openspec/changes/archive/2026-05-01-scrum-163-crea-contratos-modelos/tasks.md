...
- [x] 1.1 Revisar el issue Jira SCRUM-163 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-163/spec.md con requisitos finales.
...
Nota 3.x: En SCRUM-163 se implemento la fase de contratos base (DTOs/Models/Enums/Exceptions/Builders). Controladores/repositorios/DI quedan para fases siguientes (SCRUM-164+).
