...
- Crear artefactos base del cambio a partir del issue SCRUM-34.
...
### New Capabilities
- jira-scrum-34: Inicio de cambio OpenSpec originado en Jira issue SCRUM-34.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-34
- OpenSpec change path: openspec/changes/scrum-34-crea-componte-dymanic-ui-table/
