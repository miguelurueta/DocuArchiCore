...
- Crear artefactos base del cambio a partir del issue SCRUM-82.
...
### New Capabilities
- jira-scrum-82: Inicio de cambio OpenSpec originado en Jira issue SCRUM-82.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-82
- OpenSpec change path: openspec/changes/scrum-82-actualiza-dynamic-ui-table-ant-desing/
