...
- Crear artefactos base del cambio a partir del issue SCRUM-95.
...
### New Capabilities
- jira-scrum-95: Inicio de cambio OpenSpec originado en Jira issue SCRUM-95.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-95
- OpenSpec change path: openspec/changes/scrum-95-actualizacion-registrarradicacionentrant/
