...
|---|---|---|---|---|---|---|---|
| DocuArchi.Api | yes | implementation_required | registrar builder en DI de Program.cs para consumo backend | done | https://github.com/miguelurueta/DocuArchi.Api/pull/36 | done | archived |
| DocuArchiCore | yes | implementation_required | orquestador openspec central | done | https://github.com/miguelurueta/DocuArchiCore/pull/136 | done | archived |
| DocuArchiCore.Abstractions | no | no_code_change | solo consulta (sin cambios) | n/a | n/a | n/a | n_a |
| DocuArchiCore.Web | no | no_code_change | solo consulta (sin cambios) | n/a | n/a | n/a | n_a |
| MiApp.DTOs | yes | no_code_change | contrato WorkflowDynamicColumnDefinitionDto ya existe y cubre la entrada del builder | n/a | n/a | done | archived |
| MiApp.Services | yes | implementation_required | implementar IWorkflowDynamicUiColumnBuilder y WorkflowDynamicUiColumnBuilder | done | https://github.com/miguelurueta/MiApp.Services/pull/58 | done | archived |
