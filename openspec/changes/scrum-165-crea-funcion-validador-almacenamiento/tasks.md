...
- [x] 1.1 Revisar el issue Jira SCRUM-165 y confirmar alcance.
...
- [x] 2.1 Completar specs/jira-scrum-165/spec.md con requisitos finales.
...
- `dotnet build` validado en `MiApp.Models`, `MiApp.Services` y `DocuArchi.Api`.
- `dotnet test` del proyecto global de pruebas falla por error preexistente no relacionado en `SolicitaListaTiposRespuestaControllerTests.cs`.
