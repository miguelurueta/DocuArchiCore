...
- Crear artefactos base del cambio a partir del issue SCRUM-43.
...
### New Capabilities
- jira-scrum-43: Inicio de cambio OpenSpec originado en Jira issue SCRUM-43.
...
- Jira issue: https://contasoftcompany.atlassian.net/browse/SCRUM-43
- OpenSpec change path: openspec/changes/scrum-43-actualiza-api-radicacion/
