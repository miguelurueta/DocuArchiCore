# jira-scrum-68 Specification

## Purpose
Consultar la estructura activa de rutas workflow de radicacion usando `defaultDbAlias`, con respuesta estandarizada en `AppResponses`.
## Requirements
