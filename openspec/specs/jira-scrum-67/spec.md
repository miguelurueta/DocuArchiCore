# jira-scrum-67 Specification

## Purpose
Definir y mantener el comportamiento esperado del servicio interno que valida en memoria los datos de radicacion usados para construir tareas de workflow en SCRUM-67.
## Requirements
